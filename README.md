...
### 1.1. [Conda](https://repo.anaconda.com/archive/) or [Conda mirror soure for Chinese users](https://mirrors.tuna.tsinghua.edu.cn/anaconda/archive/) basic environment, at least version 23.9.0 
...
- #### [LLVM version &gt;= 14.0](https://apt.llvm.org/) for SYCL implementation of [AdaptiveCpp](https://github.com/AdaptiveCpp/AdaptiveCpp)(known as OpenSYCL/hipSYCL)
  ...
  ````
- #### [Intel oneAPI version &gt;= 2023.0.0](https://www.intel.com/content/www/us/en/developer/tools/oneapi/base-toolkit-download.html?operatingsystem=linux&distributions=offline) for SYCL implementation of Intel, and [codeplay Solutions](https://codeplay.com/solutions/oneapi/) if NVIDIA and AMD targeting backends are needed
