...
ELSE()
    file(MAKE_DIRECTORY ${CMAKE_SOURCE_DIR}/libs/${INIT_SAMPLE}_${SYCL_COMPILE_SYSTEM}_${SelectDv}_${ARCH}_${CMAKE_BUILD_TYPE})
    set(LIBRARY_OUTPUT_PATH ${CMAKE_SOURCE_DIR}/libs/${INIT_SAMPLE}_${SYCL_COMPILE_SYSTEM}_${SelectDv}_${ARCH}_${CMAKE_BUILD_TYPE})
ENDIF()
