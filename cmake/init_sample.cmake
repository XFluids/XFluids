...
if(USE_DOUBLE)
    message(STATUS "  Double Precision running on: ${SYCL_COMPILE_SYSTEM}/${SelectDv}_${ARCH}")
else()
    message(STATUS "  Float Precision running on: ${SYCL_COMPILE_SYSTEM}/${SelectDv}_${ARCH}")
endif()
message(STATUS "  Multi-Component: ${COP}")
message(STATUS "    DIM_X: ${DIM_X}, DIM_Y: ${DIM_Y}, DIM_Z: ${DIM_Z}")
message(STATUS "    Species' Thermo Fit: ${THERMAL}, Only NASA fit for Xe used in RSBI sample.")
