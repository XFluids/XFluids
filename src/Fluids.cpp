...
// [DEBUG], fix cpu getlu_error
// add q.memset by gemini 3.0
...
std::vector<float> Fluid::UpdateFluidURK3(sycl::queue &q, int flag, real_t const dt)
{
	return UpdateURK3rd(q, Fs.BlSz, d_U, d_U1, d_LU, dt, flag, rank);
}
