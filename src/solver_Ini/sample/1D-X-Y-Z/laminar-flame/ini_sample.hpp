                                          ...
                                          real_t *u, real_t *v, real_t *w, real_t *rho, real_t *p, real_t *_y, real_t *T, real_t *H, real_t *c)
{
    ...
    real_t x = bl.DimX ? (i - Bwidth_X + bl.myMpiPos_x * X_inner) * dx + _DF(0.5) * dx + bl.Domain_xmin : _DF(0.0);
    real_t y = bl.DimY ? (j - Bwidth_Y + bl.myMpiPos_y * Y_inner) * dy + _DF(0.5) * dy + bl.Domain_ymin : _DF(0.0);
    real_t z = bl.DimZ ? (k - Bwidth_Z + bl.myMpiPos_z * Z_inner) * dz + _DF(0.5) * dz + bl.Domain_zmin : _DF(0.0);
