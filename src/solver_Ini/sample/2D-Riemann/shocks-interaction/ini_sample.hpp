                            ...
                            real_t *u, real_t *v, real_t *w, real_t *rho, real_t *p, real_t *_y, real_t *T, real_t *H, real_t *c)
{
    ...
    real_t rho1 = _DF(1.1), p1 = _DF(1.1), u1 = _DF(0.0), v1 = _DF(0.0);
    real_t rho2 = _DF(0.5065), p2 = _DF(0.35), u2 = _DF(0.8939), v2 = _DF(0.0);
    real_t rho3 = _DF(1.1), p3 = _DF(1.1), u3 = _DF(0.8939), v3 = _DF(0.8939);
    real_t rho4 = _DF(0.5065), p4 = _DF(0.35), u4 = _DF(0.0), v4 = _DF(0.8939);
