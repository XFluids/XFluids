                            ...
                            real_t *u, real_t *v, real_t *w, real_t *rho, real_t *p, real_t *_y, real_t *T, real_t *H, real_t *c)
{
    ...
    real_t rho1 = _DF(1.0), p1 = _DF(1.0), u1 = _DF(-0.75), v1 = _DF(-0.5);
    real_t rho2 = _DF(2.0), p2 = _DF(1.0), u2 = _DF(-0.75), v2 = _DF(0.5);
    real_t rho3 = _DF(1.0), p3 = _DF(1.0), u3 = _DF(0.75), v3 = _DF(0.5);
    real_t rho4 = _DF(3.0), p4 = _DF(1.0), u4 = _DF(0.75), v4 = _DF(-0.5);
