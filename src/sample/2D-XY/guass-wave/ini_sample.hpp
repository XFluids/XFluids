...
#endif // end DIM_X
#if DIM_X && DIM_Z
    T[id] = 1350.0 + (320.0 - 1350.0) * (1 - 0.5 * sycl::exp<real_t>(-(x - 0.5) / 0.05 * (x - 0.5) / 0.05 - (z - 0.5) / 0.05 * (z - 0.5) / 0.05));
#endif // end DIM_Y
#if DIM_Y && DIM_Z
    T[id] = 1350.0 + (320.0 - 1350.0) * (1 - 0.5 * sycl::exp<real_t>(-(y - 0.5) / 0.05 * (y - 0.5) / 0.05 - (z - 0.5) / 0.05 * (z - 0.5) / 0.05));
#endif // end DIM_Y
