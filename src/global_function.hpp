...
real_t RoeAverage(const real_t ul, const real_t ur, const real_t D, const real_t D1);
// schemes
...
// original weno
real_t weno_P(real_t *f, real_t delta);
real_t weno_M(real_t *f, real_t delta);
extern SYCL_EXTERNAL real_t weno5old_P(real_t *f, real_t delta);
extern SYCL_EXTERNAL real_t weno5old_M(real_t *f, real_t delta);
...
real_t WENOAO53_P(real_t *f, real_t delta)
{
    ...
    real_t s5 = 1.0 * (s51 + 1.0/10.0 * s53) * (s51 + 1.0/10.0 * s53)
    ...
    real_t u0 = v3;
    real_t u1 = (w5 / coef_weights_5) * (s51 - coef_weights_1 * s11 - coef_weights_2 * s21 - coef_weights_3 * s31)
                            + w1 * s11 + w2 * s21 + w3 * s31;
    real_t u2 = (w5 / coef_weights_5) * (s52 - coef_weights_1 * s12 - coef_weights_2 * s22 - coef_weights_3 * s32)
...
real_t WENOAO73_P(real_t *f, real_t delta)
{
    ...
    real_t s7 = 1.0 * (s71 + 1.0/10.0 * s73 + 1.0/126.0 * s75) * (s71 + 1.0/10.0 * s73 + 1.0/126.0 * s75)
...
real_t WENOCU6_P(real_t *f, real_t delta)
{
    ...
    real_t s6 = (tau61*tau61*a1a1 + tau62*tau62*a2a2 + tau61*tau63*a1a3 + tau63*tau63*a3a3 + tau62*tau64*a2a4
...
real_t TENO6_OPT_P(real_t *f, real_t delta)
{
    ...
    real_t s64 =  1.0/12.0*std::fabs(139633.0*v6*v6 - 1429976.0*v5*v6 + 3824847.0*v5*v5 + 2863984.0*v4*v6 - 15880404.0*v4*v5 + 17195652.0*v4*v4 - 2792660.0*v3*v6
...
real_t WENOCU6M2_P(real_t *f, real_t delta)
{
    ...
    real_t s64 =  fabs(139633.0*v6*v6 - 1429976.0*v5*v6 + 2863984.0*v4*v6 - 2792660.0*v3*v6
