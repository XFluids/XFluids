...
// //-----------------------------------------------------------------------------------------
// // // low order
// SYCL_DEVICE inline real_t minmod(real_t r);
// SYCL_DEVICE inline real_t van_Leer(real_t r);
// SYCL_DEVICE inline real_t van_Albada(real_t r);
// SYCL_DEVICE inline void MUSCL(real_t p[4], real_t &LL, real_t &RR, int flag);
// SYCL_DEVICE inline real_t KroneckerDelta(const int i, const int j);
...
// // SYCL_DEVICE inline real_t weno5old_P(real_t *f, real_t delta);
// // SYCL_DEVICE inline real_t weno5old_M(real_t *f, real_t delta);
